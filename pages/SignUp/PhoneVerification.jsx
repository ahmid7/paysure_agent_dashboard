...
const PhoneVerification = () => {
    ...
    const handleClick = (e) => {
      router.push('/SignUp/VerificationSuccess')
    }

  return (
    <div tw='pt-14 w-[35%]'>
        <h2 tw='pt-4 font-semibold text-xl'>Verify your phone numner</h2>

        <p tw='py-2 text-sm'>Enter the verification code that was sent to your phone number</p>
...
PhoneVerification.accountVerificationLayout = function PageLayout(page){
    return(
        <div tw='flex'>
            <div tw="w-1/4">
